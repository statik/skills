...
1. **Update the version in SKILL.md**
   ...
   Edit `dns-troubleshooter/skills/dns-troubleshooter/SKILL.md` and update the `metadata.version` field in the frontmatter:
   ```yaml
   ---
...
2. **Commit the version bump**
   ```bash
   git add dns-troubleshooter/skills/dns-troubleshooter/SKILL.md
